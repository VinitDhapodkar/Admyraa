    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-3.5 pt-8"
        >
          <Button asChild variant="outline" className="rounded-2xl border-slate-300 hover:border-amber-500 hover:bg-amber-50/60 font-bold text-slate-800 shadow-sm">
          ...
          <Button asChild className="rounded-2xl bg-[#0b1f3a] hover:bg-[#102a4e] text-white border border-amber-400/40 shadow-md font-bold">
