      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          <ScrollReveal direction="left" className="h-full">
            <TiltCard className="p-8 sm:p-10 rounded-3xl bg-white border-2 border-slate-200/90 shadow-md hover:border-[#0b1f3a] hover:shadow-2xl transition-all duration-300 h-full flex flex-col justify-between group">
              <div>
                <div className="w-16 h-16 rounded-2xl bg-[#0b1f3a]/10 text-[#0b1f3a] border border-[#0b1f3a]/15 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-[#0b1f3a] group-hover:text-amber-400 transition-all shadow-sm">
          ...
          <ScrollReveal direction="right" className="h-full">
            <TiltCard className="p-8 sm:p-10 rounded-3xl bg-white border-2 border-slate-200/90 shadow-md hover:border-amber-400 hover:shadow-2xl transition-all duration-300 h-full flex flex-col justify-between group">
              <div>
                <div className="w-16 h-16 rounded-2xl bg-amber-50 text-amber-700 border border-amber-200/60 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-amber-500 group-hover:text-slate-950 transition-all shadow-sm">
        ...
        <ScrollReveal className="p-8 sm:p-10 rounded-3xl bg-white border-2 border-slate-200/90 shadow-xl text-center relative overflow-hidden">
          <div className="text-xs font-black uppercase tracking-wider text-slate-400 mb-6">
            Ecosystem Connectivity Model
          </div>

          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-sm font-black">
            <div className="px-5 py-3.5 rounded-2xl bg-slate-100 text-slate-900 border-2 border-slate-200 shadow-sm hover:border-amber-400 transition-all flex items-center gap-2">
            ...
            <div className="px-6 py-4 rounded-2xl bg-gradient-to-r from-[#050e1d] via-[#0b1f3a] to-[#102a4e] text-amber-300 border-2 border-amber-400/60 shadow-xl shadow-amber-950/20 scale-105 flex items-center gap-2.5">
            ...
            <div className="px-5 py-3.5 rounded-2xl bg-emerald-50 text-emerald-800 border-2 border-emerald-300 flex items-center gap-2 shadow-sm">
