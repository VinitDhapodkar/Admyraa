    ...
    <section id="services" className="py-24 bg-slate-50/70 backdrop-blur-[2px] border-t border-slate-200/70 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex p-1.5 rounded-2xl bg-white border-2 border-slate-200/90 shadow-md">
            {SITE_DATA.services.map((svc) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-6 py-3 rounded-xl text-sm font-black transition-all duration-300 ${
                    isSelected
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-7">
              <TiltCard className="p-8 sm:p-10 rounded-3xl bg-white border-2 border-slate-200/90 shadow-lg h-full flex flex-col justify-between">
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                    {currentService.features.map((feat) => (
                      <div
                        key={feat}
                        className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 flex items-center gap-3 text-sm font-bold text-slate-800 hover:border-amber-400 hover:bg-amber-50/30 transition-all"
                      >
            ...
            <div className="lg:col-span-5">
              <TiltCard className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-[#050e1d] via-[#0b1f3a] to-[#102a4e] text-white border-2 border-amber-400/40 shadow-2xl h-full flex flex-col justify-between relative overflow-hidden">
                <div className="absolute top-0 right-0 w-48 h-48 bg-amber-500/15 rounded-full blur-2xl pointer-events-none" />
                <div>
                  <span className="inline-block px-3.5 py-1 rounded-full bg-amber-400/20 text-amber-300 border border-amber-400/40 text-xs font-black tracking-wider uppercase mb-6 shadow-sm">
                    Partner with ADMYRA
                  </span>
                  <h4 className="text-2xl sm:text-3xl font-black mb-4 leading-snug text-white tracking-tight">
                    {currentService.heading}
                  </h4>
                ...
                <div className="pt-8">
                  <Button asChild size="lg" className="w-full justify-center bg-amber-500 hover:bg-amber-400 text-slate-950 font-black shadow-xl shadow-amber-950/30 rounded-xl transition-all h-13">
